...
\begin{equation}
  \frac{da}{dt} = \frac{\xi_\text{a} \rho\rms{g} w_\text{a}}{4 \rho\rms{gr}} ,
\end{equation}

\noindent
where $w_a$ is the Maxwell-Boltzmann distribution RMS velocity, $\xi_a$ is the grain sticking efficiency, $\rho\rms{g}$ is the gas density and $\rho_\text{gr}$ is the grain bulk density.
