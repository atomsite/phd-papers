...
\noindent
where $w\rms{a}$ is the Maxwell-Boltzmann distribution RMS velocity for carbon, $w\rms{C} = (3 k\rms{B} T/12 m\rms{H})^{1/2}$, $\xi$ is the grain sticking efficiency, $\rho\rms{C}$ is the carbon density in the gas and $\rho_\text{gr}$ is the grain bulk density.
