...
The energy loss per unit volume in a stellar wind due to gas and plasma emission processes can then be calculated with the formula

\begin{equation}
  \mathcal{L}\rms{w} = \left(\frac{\rho}{m_\text{H}}\right)^2 \Lambda_\text{w} (T),
\end{equation}
...
\begin{equation}
	\mathcal{L}\rms{T} = \left( \frac{\rho}{m_\text{H}} \right)^2 \Lambda_\text{w}(T) + n_\text{T} n_\text{d} \Lambda_\text{d} (T,a) .
\end{equation}
