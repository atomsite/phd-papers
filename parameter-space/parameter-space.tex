...
\noindent
where $w_a$ is the Maxwell-Boltzmann distribution RMS velocity for carbon:

\begin{equation}
  w\rms{a} = \sqrt\frac{3 k\rms{B} T}{12 m\rms{H}},
\end{equation}

\noindent
$\xi_a$ is the grain sticking efficiency, $\rho\rms{C}$ is the carbon density in the gas and $\rho_\text{gr}$ is the grain bulk density.
...
\begin{subequations}
  \begin{align}
    ...
    \frac{dm\rms{gr}}{dt} & = \frac{m \rms d}{\tau\rms{d}} = \frac{4 \pi\rho\rms{gr}  a^3}{3 \tau\rms{d}} , \\
