...
The high wind temperatures, UV photon flux and violent shocks should destroy any dust grains that condense, however a handful of systems have been observed producing dust with yields of approximately 30\% of the total mass of the stellar winds, in extreme cases.
...
The variability of the dust production rate also appears to increase as the separation distance is reduced, leading to instances where a simulation may temporarily produce more dust than a simulation with a tighter orbit, such as the case with \texttt{dsep-4AU} and \texttt{dsep-8AU} at $\phi = 0.6$ to $\phi = 0.65$.
