...
\textbf{The scalar quantities tracked in this model are:}
...
\noindent
\textbf{As there is no diffusion coefficient in Eq. \ref{eq:p2-scal}, these quantities can be interpreted as explicitly co-moving with the fluid.}
